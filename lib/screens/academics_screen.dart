...
class AcademicsScreen extends StatelessWidget {
  ...
  static const String semesterSystem1 =   "The acedemic session of the Institute is divided into three parts: two regular semeters and a summer term (though as fresher you need not to worry about summer term).Among regular semester the odd semester normally commences in the last week of July every year, and even semester in the first week of January.";
  static const String semesterSystem2 = "Academic calender of the institute for various academic activities for all of the students of the institute will/is available on the welsite of each semester.";
  @override
